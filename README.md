...
ClaimLens is a full-stack web application designed to automatically analyze the credibility of advertisements across major platforms like YouTube, Instagram, and TikTok. 
...
- **AI Services Pipeline:** Python, FastAPI, yt-dlp, ffmpeg, Groq Whisper (multilingual), EasyOCR, Gemini 1.5 Flash
